...
vim.keymap.set('n', '<leader>q', function() require("trouble").open() end, { desc = 'Open diagnostics list' })
...
local on_attach = function(_, bufnr)
  ...
  nmap('<leader>cd', vim.diagnostic.open_float, '[C]ode line [D]iagnostics')
